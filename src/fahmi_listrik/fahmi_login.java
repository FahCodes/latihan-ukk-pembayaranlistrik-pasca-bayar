 ...
 * @author Hp
 */
public class fahmi_login extends javax.swing.JFrame {
    ...
    private void jButtonLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonLoginActionPerformed
        ...
        try{
            ...
            if(rs.next()){
                ...
                fahmi_usersession.set_nama(rs.getString("nama_lengkap"));
                if(hak.equals("Admin")){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fahmi_login.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
