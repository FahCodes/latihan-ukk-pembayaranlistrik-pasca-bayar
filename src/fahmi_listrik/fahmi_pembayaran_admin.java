...
import fahmi_listrik.fahmi_dashboard_admin;
import java.io.File;
 ...
 * @author Acer
 */
public class fahmi_pembayaran_admin extends javax.swing.JFrame {

    /**
     * Creates new form fahmi_pembayaran_admin
     */
    private Statement statement;
    private ResultSet resultset;
    private fahmidb_connection con;
    public fahmi_pembayaran_admin() {
        initComponents();
    ...
    private void fahmi_simpan(){
        try{
            ...
            String SQL="INSERT INTO pembayaran values('"+id_pem.getText()
                    +"',"+"'"+tgl.getText()
                    +"',"+"'"+id_tag.getText()
                    +"',"+"'"+jlh.getText()
                    +"',"+"'"+denda.getText()
    ...
    private void fahmi_update(){
        try{
            ...
            String SQL = "UPDATE Pembayaran SET id_pembayaran='"+id_pem.getText()
                    +"',tanggal_bayar='"+tgl.getText()
                    +"',id_tagihan='"+id_tag.getText()
                    +"',jumlah_tagihan='"+jlh.getText()
                    +"',biaya_denda='"+denda.getText()
                    +"',biaya_admin='"+admin.getText()
                    +"',status='"+stat.getText()
    ...
    private void fahmi_delete(){
        try{
            ...
            String query = "DELETE FROM PEMBAYARAN WHERE id_pembayaran='"+id_pem.getText()+"'";
    ...
    private void fahmi_settabel(){
        ...
        tot.setText(("Total : "+tabel.getValueAt(kolom,7)));
    }
    ...
    private void tabelMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelMouseClicked
        ...
        + "----------------------------------------------------------\n"
        + "Terimakasih Telah Membayar Tagihan \t\n\n" 
        + " ADMIN \n\n"
        + " Fahmi");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(fahmi_pembayaran_admin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new fahmi_pembayaran_admin().setVisible(true);
            }
        });
    }
